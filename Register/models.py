...
class Student(models.Model):
    ...
    payment_amount = models.FloatField(blank=True, null=True, default=0, verbose_name="مبلغ پرداخت شده")
...
class Class(models.Model):
    ...
    class_cost = models.FloatField(blank=True, null=True, default=0, verbose_name="هزینه کلاس")
